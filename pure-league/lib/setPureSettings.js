...
import {pure_consts} from "../public/consts.js"
...
const { channelsRange, coachesStartRange, coachesEndRange, settingsSheetName, coachesEndColumn } = pure_consts.appendGoogleSheets.adamSettings
...
async function setPureSettings({sheets, message}){
    ...
    try {
        ...
        const range = `${settingsSheetName}!${coachesEndRange}`
        ...
        let ranges = [
            `${settingsSheetName}!${channelsRange}`,
            `${settingsSheetName}!${coachesStartRange}:${coachesEndColumn}${updateCoachesEndRange}`
        ]
